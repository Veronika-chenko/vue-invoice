    ...
    <form @submit.prevent="submitForm" class="invoice-content">
      ...
      <div class="bill-from flex flex-column">
        ...
        <div class="location-details flex">
          <div class="input flex flex-column">
            ...
            <input require type="text" id="billerCity" v-model="billerCity" />
          </div>
          <div class="input flex flex-column">
      ...
      <div class="bill-to flex-flex-column">
        ...
        <div class="input flex flex-column">
          ...
          <input require type="text" id="clientName" v-model="clientName" />
        </div>
        <div class="input flex flex-column">
          <label for="clientEmail">Client's Email</label>
          <input require type="text" id="clientEmail" v-model="clientEmail" />
        </div>
        <div class="input flex flex-column">
        ...
        <div class="location-details flex">
          <div class="input flex flex-column">
            ...
            <input require type="text" id="clientCity" v-model="clientCity" />
          </div>
          <div class="input flex flex-column">
      ...
      <div class="invoice-work flex flex-column">
        <div class="payment flex">
          <div class="input flex flex-column">
            ...
            <input disable type="text" id="invoiceDate" v-model="invoiceDate" />
          </div>
          <div class="input flex flex-column">
